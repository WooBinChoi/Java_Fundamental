...
public class SetDemo {
	public static void main(String[] args) {
		...
		//TreeSet 클래스는 데이터(객체)의 중복을 허용하지 않고, natural ordering(숫자일때와 정렬방식이 다름)을 한다.
		//TreeSet set = new TreeSet();
		//LinkedHashSet 클래스는 데이터의 중복을 허용하지 않고 순서는 FIFO(First In First Out)
		...
		//0(같다)가 나오면 데이터가 중복되었다고 판단하여 데이터를 추가해 주지 않음
